...
class CSModel:
    ...
    name : str
        name of the file
    seed : int
        used seed to produce deterministic results.
        Works up to the 7th decimal number of val_loss
        Default is None.
    ...
    def train(self,
        ...
        l1 = keras.layers.LSTM(hparams[HP_NUM_UNITS],
                               ...
                               dropout=hparams[HP_DROPOUT])(main_input)  # the shared layer
        ...
        l2_1 = keras.layers.LSTM(hparams[HP_NUM_UNITS],
                                 ...
                                 dropout=hparams[HP_DROPOUT])(b1)  # the layer specialized in activity prediction
        ...
        l2_2 = keras.layers.LSTM(hparams[HP_NUM_UNITS],
                                 ...
                                 kernel_initializer='glorot_uniform',
                                 return_sequences=False,
                                 dropout=hparams[HP_DROPOUT])(b1)  # the layer specialized in time prediction
